...
Claims and open questions are not extracted from the source — they are generated by the LLM during page creation or update. The LLM examines the extracted entities and concepts for each page and formulates claims and open questions directly in the page content.
